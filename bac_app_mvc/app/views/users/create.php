...
<div class="container mt-4">
    <h2><?php echo htmlspecialchars($title ?? $tr('add_user')); ?></h2>
            ...
            <div class="col-md-6">
                ...
                <div class="mb-3">
                 ...
                 <div class="mb-3 form-check form-switch">
                    <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1" <?php echo (isset($is_active) && $is_active === true || !isset($is_active)) ? 'checked' : ''; // Coché par défaut ?>>
