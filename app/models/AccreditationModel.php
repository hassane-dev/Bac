...
class AccreditationModel {
    ...
    public function delete($id) {
        // Avant de supprimer, vérifier si cette accréditation est utilisée dans roles_accreditations
        // Cette vérification est importante pour l'intégrité référentielle si ON DELETE n'est pas CASCADE
        // ou pour informer l'utilisateur. La table roles_accreditations a ON DELETE CASCADE, donc la DB s'en chargera.
        // Cependant, il peut être bon de vérifier pour des raisons métier.
